package com.wenld.simapcustom.view.largeimageload;
...
public class MoveGestureDetector extends BaseGestureDetector {
    ...
    private PointF mCurrentPointer = new PointF();
    private PointF mPrePointer = new PointF();
    //仅仅为了减少创建内存
    ...
    protected void updateStateByEvent(MotionEvent event) {
        ...
        mPrePointer.set(caculateFocalPointer(prev));
        mCurrentPointer.set(caculateFocalPointer(event));
    ...
    PointF caculateFocalPointF = new PointF();
    ...
    private PointF caculateFocalPointer(MotionEvent event) {
        ...
        x /= count;
        y /= count;
        caculateFocalPointF.set(x, y);
        return caculateFocalPointF;
    }
